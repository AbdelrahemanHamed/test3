...
const Cart = ({ showCart, handleCloseCart }) => {
        ...
        <div className={styles["cart-wrapper"]}>
          <div className={styles["cart-container"]}>
            ...
            {cart.length > 0 && (
              ...
              <Link to="/checkout"><button className={styles["order"]}>weiter</button></Link>
              </>
            )}
          </div>
        </div>
  ...
  //               <div className={styles["product-info"]}>
  //                 <h5 className={styles["product-title"]}>
  //                   Pizza Ruccola Mscarpone
  //                 </h5>
  //                 <p className={styles["product-desc"]}>Ruccola Mascarpone</p>
  //               </div>
  //             </div>
  //             <div className={styles["price-control"]}>
  //               <div className={styles["controls"]}>
  ...
  //                 <button>+</button>
  //               </div>
  //               <p className={styles["price"]}>CHF 20.00</p>
  //             </div>
  //           </div>
  //         </div>
  //         <div className={styles["total"]}>
