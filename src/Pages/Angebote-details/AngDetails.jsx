...
import image1 from "../../images/Angebote image2/Angebot-20.png"
...
import "./anebotedetails.css"
export const AngDetails = () => {
  return (
    <div>
      <div className="ang">
        <div className="inner">
          ...
          <div className="data">
            ...
            <p className="harte">
              <span>&#x2764; </span> Allergene: (Die abgebildeten Bilder dienen
              ausschliesslich als Referenz. Das tatsächliche Produkt kann
              abweichen.)
            </p>
            ...
            <div className="info-data">
              ...
              <div className="inputs">
                <input type="checkbox" />
                <label> 1x Flasche Getränk 1L</label>
              </div>
              <div className="inputs">
                <input type="checkbox" />
                <label> 1x Döner Kebab</label>
              </div>
              <p>Kebab mit Joghurtsosse?</p>
              <div className="inputs">
                <input type="checkbox" />
                <label> Ja mit Sosse</label>
              </div>
              <select name="" id="">
              ...
              <select name="" id="">
                ...
                <option>
                  (Weine/Sekte) Sekt Rotkäppchen 0.75L + CHF 10.00
                </option>
